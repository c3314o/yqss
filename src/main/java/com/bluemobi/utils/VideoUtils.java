...
public class VideoUtils {
	...
	public static Video getYouKuVideo(String url) throws Exception {
		...
		Elements elements = doc.getElementsByClass("x-video-poster");
		Element e = elements.get(0);
		String pic = e.attr("src");
	...
	public static void main(String[] args) {
		try {
			getYouKuVideo("http://v.youku.com/v_show/id_XMTQwNjU3NTI0MA==.html");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
...
//		// String url =
//		// "http://v.ku6.com/special/show_4024167/9t7p64bisV2A31Hz.html";
//		// String url = "http://v.ku6.com/show/BpP5LeyVwvikbT1F.html";
//		// String url = "http://6.cn/watch/14757577.html";
//		String url = "http://v.youku.com/v_show/id_XMTQwNjU3NTI0MA==_ev_1.html";
